...
class TestParseLine:
    ...
    def test_basic_line(self) -> None:
        ...
        expected_words = [LyricToken(content="今天天气真好", start=5000, end=None)]
    ...
    def test_explicit_end_same_line(self) -> None:
        ...
        expected_words = [
            LyricToken(content="这句歌词只持续两秒哦", start=15000, end=17000)
        ]
    ...
    def test_empty_line_timestamp(self) -> None:
        ...
        expected_words = [LyricToken(content="", start=10500, end=None)]
    ...
    def test_byword_angle_brackets(self) -> None:
        ...
        expected_words = [
            LyricToken(content="要", start=40000, end=41000),
            LyricToken(content="吃", start=41000, end=41500),
            LyricToken(content="小", start=41500, end=42000),
            LyricToken(content="鱼", start=42000, end=42500),
            LyricToken(content="干", start=42500, end=44000),
        ]
    ...
    def test_delayed_byword_start(self) -> None:
        ...
        expected_words = [
            LyricToken(content="", start=40000, end=41000),
            LyricToken(content="要", start=41000, end=41500),
            LyricToken(content="吃", start=41500, end=42000),
            LyricToken(content="小", start=42000, end=42500),
            LyricToken(content="鱼", start=42500, end=43000),
            LyricToken(content="干", start=43000, end=44000),
        ]
    ...
    def test_special_characters(self) -> None:
        ...
        expected_words = [
            LyricToken(content="好呀！=^._.^= inte", start=12000, end=None)
        ]
    ...
    def test_invalid_byword_timestamp(self) -> None:
        ...
        expected_words = [
            LyricToken(content="第一遍正常", start=50000, end=52000),
        ]
    ...
    def test_only_start_and_end(self) -> None:
        ...
        expected_words = [LyricToken(content="简单的歌词行", start=50000, end=52000)]
    ...
    def test_whitespace_handling(self) -> None:
        ...
        expected_words = [LyricToken(content="  前后有空格  ", start=30000, end=None)]
    ...
    def test_multiple_spaces_in_text(self) -> None:
        ...
        expected_words = [
            LyricToken(content="这里    有    很多空格", start=31000, end=None)
        ]
    ...
    def test_unicode_characters(self) -> None:
        ...
        expected_words = [LyricToken(content="🎵音乐🎶和😺表情", start=32000, end=None)]
    ...
    def test_no_text_after_byword(self) -> None:
        ...
        expected_words = [LyricToken(content="测试", start=45000, end=46000)]
    ...
    def test_only_byword_no_text(self) -> None:
        ...
        expected_words = [LyricToken(content="", start=47000, end=48000)]
    ...
    def test_complex_mixed_scenario(self) -> None:
        ...
        expected_words = [
            LyricToken(content="开始", start=91000, end=92000),
            LyricToken(content="唱歌", start=92000, end=93000),
            LyricToken(content="谢谢", start=93000, end=94000),
        ]
